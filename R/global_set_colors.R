...
#' set_colors("#FFFFFF")
#' 
#' set_colors("#FFFFFF", "#FF95BC", "#969696", "#000000", "#FFFFFF", "#FF0000")
#' }
#'
#' @export
set_colors <- function(marker = "#FFFFFF", coral = "#FF95BC", not_coral = "#969696", text = "#000000", plane = "#FFFFFF", cursor = "#FF0000") {
  if (!is.character(marker) || !is.character(coral) || !is.character(not_coral) || !is.character(text) || !is.character(plane) || !is.character(cursor)) {
